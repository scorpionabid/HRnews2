...
$(document).ready(function () {
    ...
    $('body').append('<div id="back-to-top" style="position: fixed; bottom: 20px; right: 20px; display: none; background-color: #007bff; color: #fff; padding: 10px 15px; cursor: pointer; border-radius: 5px;">UP</div>');
